...
export type DashboardCategoryFragment = { __typename?: 'Category', id: string, name: string, slug: string, isHidden: boolean };

export type DashboardCategoryInListFragment = { __typename?: 'Category', id: string, name: string, slug: string, isHidden: boolean, articlesCount: number };
...
export type CreateCategoryMutation = { __typename?: 'Mutation', createCategory: { __typename?: 'Category', id: string, name: string, slug: string, isHidden: boolean } };
...
export type UpdateCategoryMutation = { __typename?: 'Mutation', updateCategory: { __typename?: 'Category', id: string, name: string, slug: string, isHidden: boolean } };
...
export type DashboardCategoriesQuery = { __typename?: 'Query', categories: Array<{ __typename?: 'Category', id: string, name: string, slug: string, isHidden: boolean, articlesCount: number }> };
...
export type DashboardCategoryQuery = { __typename?: 'Query', category?: { __typename?: 'Category', articlesCount: number, id: string, name: string, slug: string, isHidden: boolean } | null };
...
export const DashboardCategoryInListFragmentDoc = {"kind":"Document","definitions":[{"kind":"FragmentDefinition","name":{"kind":"Name","value":"dashboardCategoryInList"},"typeCondition":{"kind":"NamedType","name":{"kind":"Name","value":"Category"}},"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"id"}},{"kind":"Field","name":{"kind":"Name","value":"name"}},{"kind":"Field","name":{"kind":"Name","value":"slug"}},{"kind":"Field","name":{"kind":"Name","value":"isHidden"}},{"kind":"Field","name":{"kind":"Name","value":"articlesCount"}}]}}]} as unknown as DocumentNode<DashboardCategoryInListFragment, unknown>;
