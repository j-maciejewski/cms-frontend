...
export function InsertImageUriDialogBody({ onClick }: { onClick: (payload: InsertImagePayload) => void }) {
  ...
  return (
    <>
      <TextInput label="Image URL" placeholder="" onChange={setSrc} value={src} data-test-id="image-modal-url-input" />
      <DialogActions>
        <Button
...
export default function ImagesPlugin({ uploadImages }: { uploadImages: boolean }): JSX.Element | null {
    ...
    return mergeRegister(
      editor.registerCommand<InsertImagePayload>(
        ...
        (payload) => {
          ...
          if (payload.file && uploadImages) {
            replaceImage(payload.file, imageNode, editor)
          }
