...
export default function ImageComponent(
  ...
  return (
    <Suspense fallback={null}>
      <>
        <div className="image-wrapper" style={{ position: 'relative' }} draggable={draggable}>
          <LazyImage
            className={`${isFocused ? `focused ${$isNodeSelection(selection) ? 'draggable' : ''} ` : ''}`}
            src={src}
            altText={altText}
            imageRef={imageRef}
            width={width}
            ...
            maxWidth={maxWidth}
          />
          {isPlaceholder && <div className="placeholder-spinner" />}
        </div>
