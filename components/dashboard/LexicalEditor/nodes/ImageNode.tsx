...
export class ImageNode extends DecoratorNode<JSX.Element> {
  ...
  replaceSrc(newSrc: string) {
    const writable = this.getWritable()
    writable.__src = newSrc
    writable.__isPlaceholder = false
  }
...
export function $createImageNode(
  { altText, height, maxWidth = 500, src, width, key, isPlaceholder }: ImagePayload,
): ImageNode {
  return $applyNodeReplacement(new ImageNode(src, altText, maxWidth, width, height, key, isPlaceholder))
}
